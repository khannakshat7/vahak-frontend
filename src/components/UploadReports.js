...
class UploadReports extends Component {
    ...
    submit = async (e) => {
        ...
        await fetch(`${baseUrl}/users/upload_report`, {
            method: 'post',
            headers: {
        ...
        return (
            <div className="content-wrapper">
                <Container fluid>
                        ...
                        <div className="container-fluid">
                            <div className="row row justify-content-center mb-2">
                                <div style={{ display: 'flex', justifyContent: 'center' }} className="col-sm-6 ">
                                    <h1 class="m-0 text-dark">Upload Your Reports here</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <Form>
                        <FormGroup>
                            <Label size="lg" for="exampleEmail">Report's Name</Label>
                        ...
                        <FormGroup>
                            ...
                            <Input key={this.state.theInputKey} onChange={(e) => this.handleChange("report")(e.target.files[0])} type="file" name="file" id="exampleFile" />
